...
public class ModEntities
{
	...
	public static void registerEntities()
	{
		...
		EntityRegistry.registerModEntity(new ResourceLocation(MFFJam.MODID, "villager_messager"), EntityVillagerMessager.class, "villager_messager", 2, MFFJam.instance, 60, 20, false, Color.black.getRGB(), Color.white.getRGB());
